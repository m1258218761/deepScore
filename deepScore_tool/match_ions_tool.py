            ...
            for index in range(len(bs_ions1)):              ##regular ions
                ...
                try:
                    if np.min(abs(dif_a1))<self.ppm_threshold:
                        matched_index = np.where(np_mz_intensity == np.max(np_mz_intensity[np.where(abs(dif_a1) < self.ppm_threshold)]))[0]
                ...
                try:
                    if np.min(abs(dif_a2))<self.ppm_threshold:
                        matched_index = np.where(np_mz_intensity == np.max(np_mz_intensity[np.where(abs(dif_a2) < self.ppm_threshold)]))[0]
                        np_mz_intensity=np.delete(np_mz_intensity,matched_index,0)
                        mz = np_mz_intensity[:,0]
                except:
                    pass
                ...
                try:
                    if np.min(abs(dif_b1))<self.ppm_threshold:
                        matched_index = np.where(np_mz_intensity == np.max(np_mz_intensity[np.where(abs(dif_b1) < self.ppm_threshold)]))[0]
                ...
                try:
                    if np.min(abs(dif_b2))<self.ppm_threshold:
                        matched_index = np.where(np_mz_intensity == np.max(np_mz_intensity[np.where(abs(dif_b2) < self.ppm_threshold)]))[0]
                        matched_mz.append(str(mz[matched_index][0]))
                        intensity.append(str(np_mz_intensity[matched_index,1][0]))
                ...
                try:
                    if np.min(abs(dif_y1))<self.ppm_threshold:
                        matched_index = np.where(np_mz_intensity == np.max(np_mz_intensity[np.where(abs(dif_y1) < self.ppm_threshold)]))[0]
                        matched_mz.append(str(mz[matched_index][0]))
                        intensity.append(str(np_mz_intensity[matched_index,1][0]))
                ...
                try:
                    if np.min(abs(dif_y2))<self.ppm_threshold:
                        matched_index = np.where(np_mz_intensity == np.max(np_mz_intensity[np.where(abs(dif_y2) < self.ppm_threshold)]))[0]
                        matched_mz.append(str(mz[matched_index][0]))
                        intensity.append(str(np_mz_intensity[matched_index,1][0]))
