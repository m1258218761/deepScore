...
class ResNet(nn.Module):
    def __init__(self, ResidualBlock, outnumber=11,batch_size=16,weight=[],feature_size=105):
        ...
        self.attn5 = MultiHeadedAttention(16,1024)
    ...
    def forward(self, x, y_true,batch_length):
        ...
        for n in range(len(batch_length)):
            ...
            results.append(_out)
            Attn.append(_a)
        return y_t,y_p,results,_loss,Attn
